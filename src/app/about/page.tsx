...
export const metadata: Metadata = {
  title: 'Sobre a JR Câmbio Automático - Oficina de Câmbio Automático em SP',
  description: 'Conheça a JR Câmbio Automático: oficina de câmbio automático com 15+ anos de experiência em manutenção e reparo de transmissões. Equipe especializada e garantia.',
  keywords: 'oficina de cambio automatico, manutencao de cambio automatico, sobre jr cambio automatico, especialistas cambio, reparos cambio automatico, equipe especializada',
  openGraph: {
    title: 'Sobre a JR Câmbio Automático - Especialistas em Transmissão',
    description: 'Descubra nossa história, equipe e compromisso com a excelência em manutenção de câmbio automático.',
    type: 'website',
  },
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="font-montserrat text-lg leading-relaxed">
                  ...
                  como oficina de câmbio automático, atendendo milhares de clientes com
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="font-montserrat text-steel-300 leading-relaxed">
                  Oferecer serviços de excelência em manutenção de câmbio automático, proporcionando
              ...
              <div className="text-center">
                ...
                <p className="font-montserrat text-steel-300 leading-relaxed">
                  Usamos peças de procedência e empregamos técnicos qualificados que
                  entregam reparos confiáveis e duradouros.
                </p>
              </div>
              <div className="text-center">
        ...
        {/* <div className="bg-gradient-to-r from-charcoal-950 via-steel-900 to-charcoal-900 text-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="relative p-12 text-center">
            <h2 className="font-cinzel text-4xl font-bold mb-8">Diferenciais</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
              <div>
                ...
                <p className="font-montserrat font-semibold">Avaliação Técnica</p>
              </div>
              <div>
