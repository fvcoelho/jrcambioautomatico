...
export default function AdminLayout({
  ...
  return (
    <AdminAuth>
      ...
      <nav className="bg-steel-900/90 backdrop-blur-md shadow-lg border-b border-steel-700 sticky top-0 z-50">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-2">
                <Link href="/admin/projects">
                  <Button variant="ghost" size="sm" className="text-steel-300 hover:text-white hover:bg-steel-700">
