...
export default function MapSection() {
  return (
    <section className="py-20 bg-gradient-to-br from-steel-950 via-charcoal-900 to-steel-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center mb-12">
          <h2 className="font-cinzel text-4xl md:text-5xl font-bold text-white mb-4">
            <span className="text-gradient-accent">Como Nos Encontrar</span>
          </h2>
          <p className="font-montserrat text-xl text-steel-300 max-w-3xl mx-auto">
            Estamos localizados em São Paulo, com fácil acesso e estacionamento próprio
          </p>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-steel-800 rounded-2xl p-8 h-full border border-steel-700 shadow-xl">
              ...
              <div className="mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-steel-400 text-sm">WhatsApp disponível</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <a
                  href={`https://wa.me/${businessInfo.whatsapp}?text=${encodeURIComponent('Olá! Gostaria de agendar um diagnóstico para meu câmbio automático.')}`}
                  target="_blank"
