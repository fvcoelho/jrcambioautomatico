      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  ...
                  <li>Interações com nosso chatbot do WhatsApp</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
              <li>Suas mensagens serão processadas por nosso sistema automatizado</li>
              <li>Histórico de conversas será armazenado para melhor atendimento</li>
              <li>Dados compartilhados no WhatsApp estarão sujeitos também às políticas de privacidade da Meta</li>
              <li>Você pode solicitar a exclusão de suas conversas a qualquer momento</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
              <li>Com prestadores de serviço que nos auxiliam nas operações</li>
          ...
          <section>
            ...
            <p className="text-gray-600 mb-3">De acordo com a LGPD, você tem direito a:</p>
            <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
