...
const transmissionProducts = [
  {
    ...
    description: 'Trabalhamos com ATF de alta qualidade e especificação correta para cada transmissão. Seleção técnica para desempenho e proteção do conjunto.',
    features: [
  ...
  },
  {
    ...
    description: 'Peças de procedência para câmbios automáticos de diversas marcas e modelos, com rastreabilidade e controle de qualidade.',
    features: [
  ...
  },
  {
    ...
    description: 'Kits completos para revisão e retífica, com componentes críticos selecionados para durabilidade.',
    features: [
      'Kit Master completo',
  ...
  },
  {
    ...
    description: 'Componentes eletrônicos para diagnóstico e reparo com precisão, garantindo comunicação correta do sistema.',
    features: [
      'Módulos TCM',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="font-montserrat text-xl text-steel-300 max-w-3xl mx-auto">
            Seleção técnica de peças e fluidos para manutenção de câmbio automático com padrão profissional
          </p>
        </div>
