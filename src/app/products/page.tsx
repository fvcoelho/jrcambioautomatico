...
export const metadata: Metadata = {
  ...
  description: 'Peças, fluidos ATF e kits de reparo para câmbio automático com procedência e qualidade. Seleção técnica para manutenção de câmbio automático.',
  keywords: 'peças câmbio automático, óleo ATF, fluido transmissão, kit reparo câmbio, solenoides, conversor torque, filtro câmbio, manutenção de câmbio automático',
  openGraph: {
    title: 'Peças e Fluidos para Câmbio Automático | JR Câmbio Automático',
    description: 'Peças de procedência e fluidos de alta qualidade para câmbio automático de diversas marcas.',
    type: 'website',
  },
}
...
const productCategories = [
  {
    ...
    description: 'Óleos ATF com especificação correta para diferentes tipos de câmbio automático',
  ...
  },
  {
    ...
    description: 'Peças de procedência e reposição para câmbios automáticos de diversas marcas',
  ...
  },
  {
    id: 'kits',
    name: 'Kits de Reparo',
    description: 'Kits completos para revisão e retífica de câmbios automáticos',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-cinzel text-5xl md:text-6xl lg:text-7xl mb-6 tracking-wider font-light">
            <span className="text-gradient-accent">
              Peças e Fluidos para Câmbio
            </span>
          </h1>
          <p className="font-montserrat text-xl md:text-2xl mb-8 font-light tracking-wide text-white/90 max-w-4xl mx-auto">
            Seleção técnica de peças e fluidos para preservar desempenho, durabilidade e segurança
            do seu câmbio automático
          </p>
        </div>
      </section>
        ...
        <div className="mt-20 bg-gradient-to-r from-charcoal-950 via-steel-900 to-charcoal-900 text-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="relative p-12 text-center">
            ...
            <p className="font-montserrat text-xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed">
              Nossa equipe especializada ajuda você a encontrar a peça correta para seu câmbio automático.
              Trabalhamos com peças de procedência e alternativas de qualidade.
            </p>
