      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-32 transition-all duration-300">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <NavLink href="/#nossa-oficina" scrolled={scrolled} data-track-id="nav-location">
              Localização
            </NavLink>
            ...
            >
              ...
              Agendar avaliação (11) 97182-9629
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className={`transition-colors duration-300 focus:outline-none ${scrolled ? 'text-steel-100 hover:text-white' : 'text-white hover:text-accent-300'
                }`}
            >
          ...
          <div className="md:hidden animate-slide-down">
            <div className="glass-enhanced mt-2 rounded-lg overflow-hidden">
              <div className="px-4 py-3 space-y-2">
                ...
                <MobileNavLink href="/#nossa-oficina" data-track-id="mobile-nav-location" onClick={() => setIsOpen(false)}>
                  Localização
                </MobileNavLink>
                ...
                <Link
                  ...
                  className="block bg-gradient-accent text-white px-4 py-3 rounded-lg text-base font-bold text-center hover:scale-105 transition-all duration-300 mt-4 flex items-center justify-center gap-2"
                  title="Iniciar conversa no WhatsApp"
                >
...
function NavLink({ href, children, scrolled, ...props }: {
  ...
  return (
    ...
    >
      {children}
      <div className={`absolute bottom-0 left-1/2 w-0 h-0.5 group-hover:w-3/4 transition-all duration-300 transform -translate-x-1/2 ${scrolled ? 'bg-accent-400' : 'bg-accent-400'
        }`}></div>
    </Link>
  )
}
